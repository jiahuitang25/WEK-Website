  ...
  return (
    <section id={id} className="relative h-[calc(100vh-5rem)] min-h-[600px] w-full">
      ...
      <div className="relative z-20 container mx-auto flex flex-col items-center justify-center h-full text-center text-white px-8">
        <h1 className="font-headline text-5xl md:text-7xl font-bold mb-6 animate-fade-in-down text-white">
          Building Your Future, Today.
        </h1>
        <div className="text-xl md:text-2xl mb-8 max-w-3xl animate-fade-in-up space-y-4 text-white">
          <p>
        ...
        <Button asChild size="lg" variant="default" className="bg-accent hover:bg-accent/90 text-accent-foreground animate-fade-in-up animation-delay-200 text-lg">
